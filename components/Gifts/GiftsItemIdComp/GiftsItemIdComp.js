...
import s from './GiftsItemIdComp.module.scss';
import GiftsLeftNavBar from '../GiftsLeftNavBar/GiftsLeftNavBar';
import PackageCarousel from '../../package/PackageIdComponent/PackageCarousel/PackageCarousel';
import fanushka from '../../../public/fanushka.png';
import { useRouter } from 'next/router';

const GiftsItemIdComp = () => {
  const arr = [
    { img: fanushka, id: 1 },
    { img: fanushka, id: 2 },
    { img: fanushka, id: 3 },
  ...
  return (
    <div className={s.GiftsItemIdComp}>
...
export default GiftsItemIdComp;
