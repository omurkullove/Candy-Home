...
import darichok from '../../public/darichok.svg';
  ...
  const footerArr = [
    {
      ...
      href: '/',
      obj: [
        { id: 1, title: 'Презентация компании' },
        { id: 2, title: 'Наши преимущества' },
        { id: 3, title: 'Фото с выставок, производства, видео' },
        { id: 4, title: 'Акции, скидки' },
        { id: 5, title: 'История в буклетах ' },
        { id: 6, title: 'Отзывы клиентов, благодарности' },
      ],
    },
    {
      title: 'Сладости',
      href: '/candies',
      obj: [
        { id: 7, title: 'Шоколад. Штучные изделия' },
        { id: 8, title: 'Десерты. Вафли, печенье' },
        { id: 9, title: 'Весовые конфеты' },
        { id: 10, title: 'Бакалея' },
      ],
    },
    {
      ...
      href: '/package',
      obj: [
        { id: 11, title: 'Картон. МГК' },
        { id: 22, title: 'Жесть. Банка' },
        { id: 33, title: 'Тубы. Переплетный картон' },
        { id: 44, title: 'Дерево. Кожа. ВИП' },
        { id: 56, title: 'Игрушки' },
        { id: 67, title: 'Игры. Вложения' },
        { id: 78, title: 'Распродажа' },
      ],
    },
    {
      title: 'Подарки',
      href: '/gifts',
      obj: [
        { id: 12, title: 'Модели подарков, Без упаковки' },
        { id: 1252, title: 'Подарки в МГК и Картоне' },
        { id: 433, title: 'Подарки в Жесть Банке' },
        { id: 24, title: 'Подарки Мягкие' },
        { id: 465, title: 'Подарки в Тубах' },
        { id: 1246, title: 'Подарки ВИП' },
        { id: 12357, title: 'Подарки для Взрослых' },
        { id: 512358, title: 'Корпоративные подарки' },
      ],
    },
    {
      title: 'Развлечение',
      href: '/entertainment',
      obj: [
        { id: 12351, title: 'Конкурсы' },
        { id: 5682, title: 'Анекдоты' },
        { id: 4563, title: 'Поздравления' },
      ],
    },
  ];
    ...
    <>
      <div className='container'>
        <div className={s.footerBtn}>
          <a
            className={s.navBarBtn}
            onClick={() => setIsFooterOpen(!isFooterOpen)}
          >
            <div className='gradientText'>Навигатор сайта</div>
          </a>
          <div
          ...
          >
            <div className={s.btnText}>
              <span className='gradientText'>Ваш менеджер</span>
            </div>
            <div className={s.img}>
              <Image src={darichok} objectFit='contain' alt='img' />
            </div>
          </div>
        </div>
      </div>
      <footer className={s.footer}>
        <div className='container'>
          <div className={isFooterOpen ? s.items : 'd-none'}>
            {footerArr.map((e) => (
              <div className={s.item} key={e.title}>
                <Link href={e.href}>
                  <a>
                ...
                {e.obj.map((i) => (
                  <Link href={'#'} key={i.id}>
                    <a>
                      <div className={s.text}>{i.title}</div>
                    </a>
                  </Link>
                ))}
              </div>
            ...
            <div className={s.item}>
              <div className={s.title}>Конструктор подарков</div>
              <div className={s.title}>Как заказать</div>
              <div className={s.title}>Контакты</div>
            </div>
          </div>
          <div className={s.contacts}>
            <Link href={'mailto:darica@bk.ru'}>
